...
class ModelTest(unittest.TestCase):
    ...
    def test_add_model(self):
        ...
        self.assertEqual(sdf.Light.LightType.DIRECTIONAL, light_link.type())
        ...
        self.assertEqual(1.0, light_1.constant_attenuation_factor())
        self.assertEqual(1, light_1.linear_attenuation_factor())
        self.assertEqual(0.0, light_1.quadratic_attenuation_factor())
        self.assertFalse(light_1.cast_shadows())
        self.assertEqual(Color(0.5, 0.5, 0.5), light_1.diffuse())
        self.assertEqual(Color(0.0, 0.0, 0.0), light_1.specular())
        self.assertEqual(sdf.Light.LightType.POINT, light_1.type())
