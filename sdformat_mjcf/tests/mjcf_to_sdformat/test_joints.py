...
class JointTest(unittest.TestCase):
    ...
    def test_defaults(self):
        ...
        self.assertEqual("body1_dummy_0", joint.child_link_name())
        ...
        self.assertNotEqual(None, joint)
        self.assertEqual(sdf.JointType.REVOLUTE, joint.type())
        self.assertEqual("body1_dummy_0", joint.parent_link_name())
        ...
        self.assertEqual("body3_dummy_0", joint.child_link_name())
        self.assertNotEqual(None, joint.axis(0))
