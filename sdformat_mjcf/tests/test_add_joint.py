...
class JointTest(unittest.TestCase):
    ...
    def test_revolute_joint(self):
        ...
        joint.set_type(JointType.REVOLUTE)
        joint.set_raw_pose(self.test_pose)
        joint_axis = sdf.JointAxis()
        joint_axis.set_xyz(Vector3d(1, 0, 0))
    ...
    def test_revolute_joint_with_limits(self):
        ...
        joint_axis = sdf.JointAxis()
        joint_axis.set_xyz(Vector3d(1, 0, 0))
        joint_axis.set_lower(-pi / 4)
        joint_axis.set_upper(pi / 2)
        joint.set_axis(0, joint_axis)
    ...
    def test_revolute_joint_with_dynamics(self):
        ...
        joint_axis = sdf.JointAxis()
        joint_axis.set_xyz(Vector3d(1, 0, 0))
        joint_axis.set_damping(0.1)
        joint_axis.set_friction(0.2)
        joint_axis.set_spring_stiffness(0.3)
        joint_axis.set_spring_reference(pi/6)
        joint.set_axis(0, joint_axis)
    ...
    def test_prismatic_joint(self):
        joint = sdf.Joint()
        joint.set_name("joint1")
        joint.set_type(JointType.PRISMATIC)
        joint.set_raw_pose(self.test_pose)
        joint_axis = sdf.JointAxis()
        joint_axis.set_xyz(Vector3d(1, 0, 0))
        joint.set_axis(0, joint_axis)
    ...
    def test_prismatic_joint_with_limits(self):
        ...
        joint_axis = sdf.JointAxis()
        joint_axis.set_xyz(Vector3d(1, 0, 0))
        joint_axis.set_lower(-5)
        joint_axis.set_upper(10)
        joint.set_axis(0, joint_axis)
    ...
    def test_prismatic_joint_with_dynamics(self):
        ...
        joint_axis.set_friction(0.2)
        joint_axis.set_spring_stiffness(0.3)
        joint_axis.set_spring_reference(0.4)
        joint.set_axis(0, joint_axis)
